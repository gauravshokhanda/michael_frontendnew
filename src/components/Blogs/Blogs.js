...
const Blogs = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Add headers with Authorization and multipart/form-data
      const config = {
        headers: {
          "Content-Type": "multipart/form-data",
          Authorization:
            "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY3NDAzMzFlNzZjODI2Y2RjOWMwOWQ3NCIsImlhdCI6MTczMjI2ODU5NCwiZXhwIjoxNzM0ODYwNTk0fQ.JpdRtppCZ5j6G_Fd2ZxIYffy6rRYQMPLiOobT0I3T-4",
          ...formData.getHeaders(), // Adds additional headers generated by FormData
        },
      };
      ...
      if (editMode) {
        ...
        // Update the existing row in the DataGrid
        setRows((prevRows) =>
          prevRows.map((row) =>
            row.id === currentBlogId ? { ...row, ...response.data } : row
          )
        );
      } else {
        // Add new blog
  ...
  const columns = [
    ...
    { field: "content", headerName: "Content", flex: 3, minWidth: 300 },
